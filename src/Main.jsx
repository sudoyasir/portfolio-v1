...
import Product7 from '../src/img/product-7.png'
        ...
        <section id='projects'>
            <div className="container px-0">
                ...
                <div className="row" data-aos="" data-aos-duration="2000">
                    <div className="col-md-6 rounded-5 mt-4" data-aos="fade" data-aos-duration="3000">
                        <div className="product">
                            <div><img src={Product7} className='img-fluid rounded-5' alt="" /></div>
                            <h3 className='productText'>Birthday Remainder</h3>
                            <a href='https://yasir2002.github.io/birthdays' target='_blank' rel="noreferrer" className='eyeIcon'><i className='fa fa-eye'></i></a>
                            <span data-bs-toggle="offcanvas" data-bs-target="#birthdays" aria-controls="offcanvasRight" className='linkIcon'><i className='fa fa-circle-info'></i></span>
                        </div>
                    </div>
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="birthdays" aria-labelledby="offcanvasRightLabel">
                        <div class="offcanvas-header">
                            <h5 id="offcanvasRightLabel">Birthday Remainder</h5>
                            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body">
                            <p>
                                The Birthday List App is a mini project I created using ReactJS, ExpressJS, and MongoDB. It's a web application that allows users to create a list of their friends and family members' birthdays and store them in a database for future reference.
                            </p>
                            <h5>Features:</h5>
                            <ul>
                                <li>Add new birthdays with the name and date</li>
                                <li>View a list of all birthdays in the database</li>
                            </ul>

                            <h5>Technology stack:</h5>
                            <ul>
                                <li>ReactJS for the front-end user interface</li>
                                <li>ExpressJS for the back-end API server</li>
                                <li>MongoDB for data storage and retrieval</li>
                                <li>GitHub Pages for hosting the front-end</li>
                                <li>AWS for hosting the back-end API server</li>
                            </ul>
                            <a href="https://yasir2002.github.io/birthdays" target='_blank' rel="noreferrer"><button className='btn btnContact rounded-pill px-4 py-2'>Visit Site</button></a>
                        </div>
                    </div>
